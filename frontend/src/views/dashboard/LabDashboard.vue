<template>
    <el-container style="min-height:100%; width: 100%; margin-top: -100px;">
      ...
      <el-aside width="240px" class="sidebar">
        <el-menu
          ...
          <el-menu-item index="labSorting">
            <el-icon><sort /></el-icon>
            <span slot="title">Lab Sortering</span>
          </el-menu-item>
          <el-menu-item index="addSample">
            <el-icon><list/></el-icon>
            <span slot="title">Prøver</span>
          </el-menu-item>
  ...
  import HomeLabView from '../lab/HomeLabView.vue'
  import SampleView from '../lab/SampleView.vue'
  import DBView from '../admin/tools/DBView.vue'
  import LabSortingView from '../lab/LabSortingView.vue'
